...
import {AiOutlineHome, AiOutlineMail, AiOutlineUser, AiFillGithub, AiFillLinkedin} from 'react-icons/ai'
...
export function Modal(){
  ...
  if(valueModal){
    return (
      <div className="bg-dark-black-1 w-full h-full fixed top-0 left-0 z-10 flex items-center justify-center" onClick={()=>{setModal()}}>
         <motion.div 
          ...
          >
            <ul>
              <Link href="/" className="">
                <li className="flex items-center p-2 gap-2 text-lg transition ease-in-out duration-300 text-gray-400 hover:bg-white/20 hover:text-white "><AiOutlineHome /> Home</li>
              </Link>
              <Link href="/" className="">
              ...
              <Link href="/projects" className="">
                <li className="flex items-center p-2 gap-2 text-lg transition ease-in-out duration-300 text-gray-400 hover:bg-white/20 hover:text-white"><BsLightningCharge /> Projects</li>
              </Link>
              <Link href="/techs" className="">
              ...
              <Link href="https://www.linkedin.com/in/feelipesantana/" target="_blank">
                <li className="flex items-center p-2 gap-2 text-lg transition ease-in-out duration-300 text-gray-400 hover:bg-dark-blue-500 hover:text-white"><AiFillLinkedin /> Linkedin</li>
              </Link>
